...
import libImg from '../../images/lib-1.jpg';
import readingImg from '../../images/reading-hero.jpg';
                ...
                <div className='row g-0 mt-5'>
                    <div className='col-sm-6 col-md-6'>
                        <div className='col-image-left'>
                            <img src={libImg} height={"400px"} alt="liberart img" />
                        </div>
                    </div>
                ...
                <div className='row g-0'>
                    ...
                    <div className='col-sm-6 col-md-6'>
                        <div className='col-image-right'>
                            <img src={readingImg} height={"400px"} alt="reading img" />
                        </div>
                    </div>
                </div>
            </div>
